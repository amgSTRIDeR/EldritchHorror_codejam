...
- **5 уровней сложности**:
  - Очень легкий (Very Easy) - используются карты со снежинками
  - Легкий (Easy) - исключаются карты со щупальцами
  - Нормальный (Normal) - используются все карты
  - Тяжелый (Hard) - исключаются карты со снежинками
  - Очень тяжелый (Very Hard) - используются карты со щупальцами
...
- **Интерактивный просмотр карт**: просмотр карт Древних и карт мифов по клику
